...
| HU-16 | EP-08 | Pantalla principal clara | Alta | 4 | **PARCIAL (base en Sprints 1-3)** | El layout con sidebar/topbar y el dashboard ya existen (`resources/views/layouts/app.blade.php`, `dashboard/index.blade.php`) con KPIs reales: asociados, facturado del período, cobrado del mes, deuda pendiente y facturas vencidas. Pulido final de UX queda para Sprint 4. |
